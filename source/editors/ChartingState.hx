...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Force Fullscreen', "Value 1: Set to 1 to turn off fullscreen and 2 to turn it on\nanything else with make fullscreen toggled"],
		['Window Shake', "Value 1: Duration \nValue 2: intensity\n\nAlso please PLEASE don't set value 2 over 0.5\nI mean you can but just... please dont"],
		['Flash', "Flash the camera.. not much else to say\nValue 1: Color, putting nothing will make it white\nValue 2: How long the flash lasts"]
	];
